...
con_file_name = "connectionInfo_realtime_1"
...
# need_track.to_excel("20172018가입자들의현황.xlsx", index = False)
send_to_gbq(need_track, "dsCafe24","tbCustomerPrivacy_needtrack_cluster1", json_file_path=json_file_path, if_exists="replace")