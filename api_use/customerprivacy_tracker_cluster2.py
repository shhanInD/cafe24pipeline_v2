...
con_file_name = "connectionInfo_realtime_2"
...
send_to_gbq(need_track, "dsCafe24","tbCustomerPrivacy_needtrack_cluster2", json_file_path=json_file_path, if_exists="replace")