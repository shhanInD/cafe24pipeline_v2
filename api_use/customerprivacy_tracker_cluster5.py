...
con_file_name = "connectionInfo_realtime_5"
...
send_to_gbq(need_track, "dsCafe24","tbCustomerPrivacy_needtrack_cluster5", json_file_path=json_file_path, if_exists="replace")