...
def backfill(backfill_startdate,
             backfill_enddate,
             auth_key, con_path,
             orders_str='order_id,order_date,payment_date,subscription,member_id,payment_amount,payment_method_name,payment_method,use_escrow,transaction_id,cancel_date,items,receivers,buyer,return,cancellation,exchange',
    ...
    for date in date_range:
        ...
        if date == '2022-11-24':
            ...
            for timeslot in timeslots:
                ...
                url1 = f"https://wiselycompany.cafe24api.com/api/v2/admin/orders?{timeslot}&limit={limit}&embed=items,receivers,buyer,return,cancellation,exchange"
...
# load check
# orders_backfill = backfill('20221126', '20221126',auth_key='WkJTclhlUzJLYUxRYjl5TFpydXRrRzpsbW1RREJRUU54Y3FDTkVBQjFEek1D', con_path='/Users/wisely/Dropbox/Future/Data analyst/Company/wisely/Cafe24API/')
